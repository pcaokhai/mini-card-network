...
func TestTranLogRepository_findsRowsWhoseOutcomeWasNeverRecorded__POS_G16(t *testing.T) {
	...
	insert := func(rrn, tranType, status string, sentAt time.Time) int64 {
		id, err := repo.Insert(ctx, TranLogRow{RRN: rrn, Type: tranType, Status: status, Amount: 1000, Currency: "704",
	...
	require.Equal(t, []string{"626514001001", "626514001003", "626514001006"}, rrns)
}
