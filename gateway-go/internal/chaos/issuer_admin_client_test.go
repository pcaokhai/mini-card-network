...
func TestIssuerAdminClient_readsLedgerBalanceByCardRef__CHA_G1(t *testing.T) {
	...
	balance, err := NewIssuerAdminClient(srv.URL).LedgerBalance(context.Background(), "crd_normal0001")
...
func TestIssuerAdminClient_non200IsAnError__CHA_G1(t *testing.T) {
	...
	_, err := NewIssuerAdminClient(srv.URL).LedgerBalance(context.Background(), "crd_missing0001")
...
func TestIssuerAdminClient_missingLedgerBalanceIsAnError__CHA_G1(t *testing.T) {
	...
	_, err := NewIssuerAdminClient(srv.URL).LedgerBalance(context.Background(), "crd_normal0001")
	require.Error(t, err)
}
