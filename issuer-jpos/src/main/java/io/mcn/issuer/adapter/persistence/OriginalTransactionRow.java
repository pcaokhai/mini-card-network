 ...
 * LocateAndReverse} needs, including the row's own id (never exposed by {@link TranLogRow},
 * which is built for dedupe-replay use, not for a caller that has to reference the row back).
 */
