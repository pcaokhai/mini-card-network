...
| 1.4 | 2026-09-26 | SEC-G15 (issuer never used a rotated ZAK/ZPK, including the 0430 MAC), SEC-G17 (idempotent key-change advice) and SEC-G18 (replayed old key rejected) marked Fixed in #122. |
