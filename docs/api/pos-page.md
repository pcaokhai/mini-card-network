...
| 1.1 | 2026-09-25 | POS-G17 (refunds credit) and POS-G18 (reversals never restored balances) added and marked Fixed in #119; balance inquiry approved with DE 54 (POS-G6 note); rulings R-1 (reversals always post, may overdraw), R-2 (duplicate inquiry replays DE 54), R-3 (reversal frees velocity). |
